 ...
 * @example <caption>fetchJsonTest as returning function using the await keyword</caption>
 * const data = await fetchJsonTest('https://api-url.com/endpoint/')
 * @example <caption>fetchJsonTest as oneliner using the then() structure.</caption>
 * fetchJsonTest('https://api-url.com/endpoint/').then((data)=>{
 *  // use data...
 * )
 *
...
export default async function fetchJsonTest(url, payload = {}) {
   try{
